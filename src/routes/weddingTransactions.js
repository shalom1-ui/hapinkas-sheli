...
const WEDDING_EXPENSE_CATEGORIES = [
  ...
  "הלוואות", // תוקן (משוב אמיתי: "אין קטגוריות בתנועות של הלוואות גם בחתונה צריך שיהיה")
];
// "הלוואות" נוספה גם כהכנסה (לקיחת הלוואה למימון החתונה) וגם כהוצאה (החזר הלוואה) - אותה בקשה בדיוק כמו בתנועות הרגילות.
const WEDDING_INCOME_CATEGORIES = ["תרומות", "הלוואות"];
